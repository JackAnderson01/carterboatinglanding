  ...
  return (
    <div className="px-6 md:px-24 pt-12 font-sans leading-normal tracking-normal">
      ...
      <div className="pt-[6px]">
        <div>
          <p className="mb-3">
            Carter Boating (“we,” “our,” or “us”) is committed to protecting
            your privacy. This Privacy Policy explains how your personal
            information is collected, used, and disclosed by Carter Boating.
          </p>
          <p className="mb-3">
            This Privacy Policy applies to our app, and its associated
            subdomains (collectively, our “Service”) alongside our application,
            Carter Boating. By accessing or using our Service, you signify that
        ...
        <div className="pt-[18px]">
          <h2 className="text-xl lg:text-2xl font-bold leading-snug mb-3">
          ...
          <ul className="list-disc mb-3 indent-1 space-y-2 list-outside">
            ...
            <li className="indent-px ml-4">
              ...
              “our,” it refers to Carter Fishing, (1660-1 Norman Park Dr,
              Tallahassee, FL, 32304), that is responsible for your information
            ...
            <li className="indent-px ml-4">
              ...
              up to use the Carter Boating Service to manage the relationships
            ...
            <li className="indent-px ml-4">
              Personnel: refers to those individuals who are employed by Carter
              Boating or are under contract to perform a service on behalf of
              one of the parties.
            </li>
            <li className="indent-px ml-4">
            ...
            <li className="indent-px ml-4">
              App/Application: Carter Boating app, refers to the SOFTWARE
        ...
        <div className="pt-[18px]">
          <h2 className="text-xl lg:text-2xl font-bold leading-snug mb-3">
            When does Carter Boating use end user information from third
            parties?
          </h2>
          <p className="mb-3">
            Carter Boating will collect End User Data necessary to provide the
            Carter Boating services to our customers. End users may voluntarily
        ...
        <div className="pt-[18px]">
          <h2 className="text-xl lg:text-2xl font-bold leading-snug mb-3">
            When does Carter Boating use customer information from third
            parties?
          </h2>
          <p className="mb-3">
            ...
            interest in becoming a Carter Boating customer, we receive
            information from a third party that provides automated fraud
            detection services to Carter Boating. We also occasionally collect
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            Carter Boating will collect personal information that you submit to
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            Carter Boating to you and fulfill the purposes described in this
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            information you transmit to Carter Boating or guarantee that your
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            Carter Boating is incorporated in United States. Information
        ...
        <div className="pt-[18px]">
          <h2 className="text-xl lg:text-2xl font-bold leading-snug mb-3">
            Is the information collected through the Carter Boating Service
            secure?
          </h2>
          <p className="mb-3">
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            information Carter Boating collects depend on your relationship with
            Carter Boating. Personnel may update or correct their information as
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            If you are a Carter Boating worker or applicant, we collect
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            all of the assets of Carter Boating or any of its Corporate
            Affiliates (as defined herein), or that portion of Carter Boating or
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            control with Carter Boating, whether by ownership or otherwise. Any
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            shall govern this Agreement and your use of the app. Your use of the
            app may also be subject to other local, state, national, or
            international laws.
          </p>
          <p className="mb-3">
            By using Carter Boating or contacting us directly, you signify your
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            it's being used. By using our Carter Boating, registering an
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            contain links to other websites not operated or controlled by Carter
            Boating. We are not responsible for the content, accuracy or
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            party sites. Carter Boating does not make any representation as to
          ...
          <p className="mb-3">
            Advertising keeps Carter Boating and many of the websites and
          ...
          <p className="mb-3">
            ...
            Carter Boating of the third party sites, goods or services. Carter
            Boating takes no responsibility for the content of any of the ads,
            promises made, or the quality/reliability of the products or
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            Carter Boating uses "Cookies" to identify the areas of our app that
        ...
        <div className="pt-[18px]">
          ...
          <ul className="list-disc mb-3 indent-1 space-y-2 list-outside">
            <li className="indent-px ml-4">
              ...
              to name a few. Google Maps API may collect information from You
              and from Your Device for security purposes. Google Maps API
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            the right thing to do. At Carter Boating we strongly believe that
        ...
        <div className="pt-[18px]">
          ...
          <p className="mb-3">
            ...
            rights requirements of GDPR. Carter Boating processes or stores all
        ...
        <div className="pt-[18px]">
          <h2 className="text-xl lg:text-2xl font-bold leading-snug mb-3">
            Phone Number Collection, Usage, and Verification
          </h2>
          <p className="mb-3">
            For purposes of user verification and to uphold the integrity of the
            Carter Boating platform, we require the collection of your phone
            number. During the registration process, a One-Time Password (OTP)
            will be sent to the phone number provided to confirm its
            authenticity and ensure that access is granted exclusively to
            genuine users. This verification process is implemented as a measure
            to prevent the use of false or spam numbers within our platform.
          </p>
          <p className="mb-3">
            Your phone number will remain confidential and will not be disclosed
            to third-party entities, shared with external platforms, or used for
            any marketing or promotional activities. It is utilized solely for
            the purpose of verifying user identity and facilitating necessary
            communications between renters and boat owners as it pertains to
            booking and rental activities on Carter Boating.
          </p>
        </div>
        <div className="pt-[18px]">
          <h2 className="text-xl lg:text-2xl font-bold leading-snug mb-3">
